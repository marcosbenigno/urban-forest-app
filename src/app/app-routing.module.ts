...
const routes: Routes = [
  ...
  {
    path: 'full-post',
    loadChildren: () => import('./full-post/full-post.module').then( m => m.FullPostPageModule)
  },  {
    path: 'followed-by',
    loadChildren: () => import('./followed-by/followed-by.module').then( m => m.FollowedByPageModule)
  },
  {
    path: 'following',
